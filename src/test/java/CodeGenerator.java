...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://10.69.57.147:8091/pacs?useUnicode=true&characterEncoding=utf-8&useOldAliasMetadataBehavior=true";
    private static final String JDBC_USERNAME = "pacs";
    private static final String JDBC_PASSWORD = "t9ioE7gzfIol1t";
